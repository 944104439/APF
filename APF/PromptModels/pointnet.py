...
class Encoder_large(nn.Module):  # Embedding module
    def __init__(self, encoder_channel, in_channel):
        super().__init__()
...
class PointNet(nn.Module):
    def __init__(self, embed_dim, num_group, group_size, in_channel):
        super().__init__()
        self.encoder = Encoder_large(embed_dim, in_channel)
